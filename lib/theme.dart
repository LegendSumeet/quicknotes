...
abstract class QuickieThemes {
  ...
  static bool isThreeColumnMode(BuildContext context) =>
      MediaQuery.of(context).size.width > QuickieThemes.columnWidth * 3.5;
  ...
  static ThemeData buildTheme(
    ...
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(
        toolbarHeight: QuickieThemes.isColumnMode(context) ? 72 : 56,
        shadowColor: QuickieThemes.isColumnMode(context)
            ? Colors.grey.withAlpha(64)
            : null,
        surfaceTintColor:
            QuickieThemes.isColumnMode(context) ? colorScheme.surface : null,
        backgroundColor:
            QuickieThemes.isColumnMode(context) ? colorScheme.surface : null,
